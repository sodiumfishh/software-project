...
export default function UpcomingEvent() {
    return (
        <div className="px-4 py-8 container mx-auto max-w-max">
            <div className="flex justify-between items-center">
                <h3 className="my-6 text-2xl">Upcoming online events</h3>
            ...
            <div className="flex flex-wrap justify-center gap-10">
                <div className="flex flex-col">
                    ...
                    <h5 className="text-slate-500 text-xs uppercase mb-3">Sun, Sep 10 · 9:00 PM UTC</h5>
                    <h4 className="text-lg">Classic Video and Arcade Games Chat</h4>
                    <p className="text-slate-500 text-sm">New York Classic Video & Arcade Game Group</p>
                    <AvatarGroup />
                </div>
                <div className="flex flex-col">
